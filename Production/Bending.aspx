<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Bending.aspx.cs" Inherits="Production_Bending" %>
 ...
 <script>     
     function SuccessResult(msg) {
         swal("Success", msg, {
             ...
             window.location.href = "Bending.aspx";
         });
     };
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row">
                        <div class="col-9 col-md-10">
                            <h4 class="mt-4 "><b>BENDING LIST</b></h4>
                        </div>
                    </div>
                    <hr />
                    <div>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ACTION" HeaderStyle-Width="120">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton runat="server" ID="btnEdit" ToolTip="Save Quantity" CausesValidation="false" CommandName="Edit" CommandArgument='<%# Container.DataItemIndex %>'><i class="fa fa-edit"  style="font-size: 26px; color:blue; "></i></i></asp:LinkButton>
